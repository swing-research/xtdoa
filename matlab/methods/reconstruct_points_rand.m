function [X_bef, X_aft] = reconstruct_points_rand(T, d, known_delay, sdr_init, rand_restarts, solver)
% Reconstruct geometry with or without multiple random restarts
...
if sdr_init
    ...
    X_bef = relaxcalib_2x2(T, d, known_delay, solver);
else 
...
for i_rand = 1:rand_restarts
    [R_est, S_est, ~] = refine_positions_lm(R_est, S_est, T,  known_delay);
